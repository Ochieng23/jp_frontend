    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="lg:ml-64 min-h-screen flex flex-col">
        ...
        <div className="lg:hidden sticky top-0 z-20 bg-[#1b0f33] h-14 flex items-center px-4 gap-3">
          ...
          <span className="text-white font-bold text-sm flex-1">Cazini Admin</span>
          <button
            onClick={handleLogout}
            disabled={loggingOut}
            className="p-2 rounded-lg text-purple-100 hover:bg-white/10 transition-colors cursor-pointer disabled:opacity-60"
            aria-label="Sign out"
            title="Sign out"
          >
            {loggingOut ? (
