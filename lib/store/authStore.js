...
function readUserFromCookie() {
  ...
  try {
    ...
    // Next.js URL-encodes cookie values when setting them, so base64
    // padding ('=') arrives as '%3D' — decode before atob or it throws
    // and the user silently stays null after every full page load.
